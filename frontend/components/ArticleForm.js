...
export default function ArticleForm(props) {
  ...
  const { postArticle, currentArticleId, updateArticle, setCurrentArticleId, articles } = props

  const currentArticle = articles.find((art) => {
    if (currentArticleId === art.article_id) { 
      return art
    }
  })  
  ...
  const onSubmit = evt => {
    ...
    currentArticle ? updateArticle(payload, currentArticle) : postArticle(payload),
    reset()
